...
Problem: Bị giới hạn bởi MONAI model zoo
"""
...
# Option 2 - Baseline: MONAI models only (limited to MONAI model zoo)
# ============================================================================
...
# ============================================================================
# PHASE 3: Model - MONAI DenseNet121 (limited to MONAI zoo)
# KEY: Cannot use external models from torchvision/HuggingFace
# ============================================================================
...
print(f"\nModel: MONAI DenseNet121 (Parameters: {params:,})")
...
print("\n" + "="*70)
print(f"RESULTS - Avg Confidence: {avg_confidence:.3f} (untrained, random)")
print("="*70)
print("\n[X] LIMITATIONS: Limited to MONAI zoo, no pretrained weights")
print("💡 Solution: See demo_wrapper_adapter.py for external model integration")
