...
# Option 3 - Baseline: Single MONAI model (for comparison with ensemble)
# ==============================================================================
...
print("\n" + "="*70)
print(f"RESULTS - Avg Confidence: {avg_confidence:.3f} (single model, untrained)")
print("="*70)
print("\n[X] LIMITATION: Single model only")
print(">> Solution: See demo_with_ensemble.py for multi-model ensemble")
